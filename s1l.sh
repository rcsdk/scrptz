...
# Create swap file of 16GB
fallocate -l 16G /swapfile
chmod 600 /swapfile
mkswap /swapfile
swapon /swapfile
echo "/swapfile none swap sw 0 0" >> /etc/fstab
check_success "Swap file created and configured"
...
sudo pacman -S --noconfirm ufw apparmor openvpn chromium xorg-xinit xorg mesa intel-media-driver zramswap thermald tlp preload snapd
