...
dependencies=("bc" "smartmontools" "hdparm" "systemd" "auditd" "apparmor-utils" "gzip" "net-tools" "lsof" "cron" "psmisc" "iptables" "vim" "chkrootkit" "rkhunter" "lynis" "clamav" "clamav-daemon" "fail2ban" "apparmor" "clamav-freshclam" "net-tools" "nmap" "tcpdump" "iotop" "htop" "gdb" "strace" "ltrace")
